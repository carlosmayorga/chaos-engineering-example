...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/v1/secure/login/oauth/token").permitAll()
                                .antMatchers(HttpMethod.GET, "/v1/account/list", "v1/saving/list").permitAll()
                                .antMatchers(HttpMethod.GET,"/v1/account/{id}/amount/{amount}").hasAnyRole("PROFILE01","PROFILE05")
